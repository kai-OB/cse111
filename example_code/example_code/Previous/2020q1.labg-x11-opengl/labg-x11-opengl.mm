...
.RCS "$Id: labg-x11-opengl.mm,v 1.267 2020-03-06 17:57:52-08 - - $"
.PWD
.URL
.nr HISTORY 0 1
.de PROMPT
...
.P
A student mentioned in Piazza\(::
.ft I
PSA\(::
if
.V= x2go
gives you a black screen,
change it from GNOME to XFCE.
The GNOME desktop doesn't play nice with
.V= x2go .
The timeshare also has XFCE installed,
