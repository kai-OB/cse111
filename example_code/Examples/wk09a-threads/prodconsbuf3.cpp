// $Id: prodconsbuf3.cpp,v 1.32 2016-05-23 15:23:23-07 - - $
...
template <typename Type, size_t size>
void bounded_buffer<Type,size>::push_back (const value_type& val) {
   if (full()) throw bounded_buffer_error ("push_back (full)");
